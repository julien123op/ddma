...
<!-- Mirrored from vetra.laborasyon.com/demos/default/buyer-addresses.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 09 Jan 2022 15:53:00 GMT -->
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title> My Addresses - Vetra | E-Commerce HTML Admin Dashboard Template </title>
        ...
        <ul>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li>
                        <a  class="active"
                            href="buyer-addresses.html">Addresses</a>
                    </li>
                    <li>
            ...
            <div class="card">
                <div class="card-body">
                    <ul class="nav nav-pills flex-column gap-2">
                        <li class="nav-item">
                            <a class="nav-link " href="buyer-dashboard.html">Dashboard</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " href="buyer-orders.html">My Orders</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link  active " href="buyer-addresses.html">My Addresses</a>
                        </li>
                        <li class="nav-item">
