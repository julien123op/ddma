...
<head>
    ...
    <title>DD-M.A. | Liste des demandes de congés </title>
                                ...
                                <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$conemp->id}}</td>
                                            <td>{{$conemp->nomp}}</td>
                                            <td>{{$conemp->prenomp}}</td>
                                            <td>{{$conemp->motif}}</td>
                                            <td>{{$conemp->datedebut}}</td>
                                            <td>{{$conemp->datefin}}</td>
                                            <td><form class="row g-3" method="post" action="mailto:{{$conemp->email}}?Votre demande de congé a été validée">
                                                
                                            <td><button type="submit" class="btn btn-success">Validée</button></td>
                                            </td>
                                            <td><form class="row g-3" method="post" action="mailto:{{$conemp->email}}?Désolé votre demande de congé a été rejetée">
                                               
                                                
                                            <td><button type="submit" class="btn btn-danger">rejetée</button></td>
                                            </td>
                                        </tr>
                                        @endforeach
